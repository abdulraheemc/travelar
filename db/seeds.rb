...
#   Mayor.create(name: 'Emanuel', city: cities.first)
 ...
 @user = User.create(name: 'user1', email: 'user1@user.com', password: 'password', password_confirmation: 'password')
 @user = User.create(name: 'user2', email: 'user2@user.com', password: 'password', password_confirmation: 'password')
 @user = User.create(name: 'agent1', email: 'agent1@agent.com', password: 'password', password_confirmation: 'password')
 @user = User.create(name: 'agent2', email: 'agent2@agent.com', password: 'password', password_confirmation: 'password')
 ...
 @package = Package.create(name: 'Mumbai Umrah', price:10000,duration: '10days',  agency_id: 2, starting_city: 'Mumbai',  ticket_no: 20, trip_to: 'Hajj')
 ...
 @package = Package.create(name: 'Vijaywada Umrah', price:14000,duration: '7days',  agency_id: 3, starting_city: 'Vijaywada',  ticket_no: 20, trip_to: 'Hajj')
 ...
 @package = Package.create(name: 'Mumbai Umrah 1', price:9000,duration: '10days',  agency_id: 2, starting_city: 'Mumbai',  ticket_no: 20, trip_to: 'Hajj')
 ...
 @package = Package.create(name: 'Vijaywada Umrah 1', price:4000,duration: '7days',  agency_id: 1, starting_city: 'Vijaywada',  ticket_no: 20, trip_to: 'Hajj')
